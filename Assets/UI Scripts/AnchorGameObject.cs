...
public class AnchorGameObject : MonoBehaviour
{
    ...
    IEnumerator UpdateAnchorAsync()
    {
        ...
        while (CameraView.Instance == null)
        {
            ++cameraWaitCycles;
    ...
    void UpdateAnchor()
    {
        switch (anchorType)
        {
            case AnchorType.BottomLeft:
                SetAnchor(CameraView.Instance.BottomLeft);
                break;
            case AnchorType.BottomCenter:
                SetAnchor(CameraView.Instance.BottomCenter);
                break;
            case AnchorType.BottomRight:
                SetAnchor(CameraView.Instance.BottomRight);
                break;
            case AnchorType.MiddleLeft:
                SetAnchor(CameraView.Instance.MiddleLeft);
                break;
            case AnchorType.MiddleCenter:
                SetAnchor(CameraView.Instance.MiddleCenter);
                break;
            case AnchorType.MiddleRight:
                SetAnchor(CameraView.Instance.MiddleRight);
                break;
            case AnchorType.TopLeft:
                SetAnchor(CameraView.Instance.TopLeft);
                break;
            case AnchorType.TopCenter:
                SetAnchor(CameraView.Instance.TopCenter);
                break;
            case AnchorType.TopRight:
                SetAnchor(CameraView.Instance.TopRight);
                break;
        }
    }
